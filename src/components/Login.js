...
const Login = () => {
    ...
    const HandleSubmit = (e) => {
        ...
        fetch(`${REACT_APP_BACKEND_END_POINT}/auth/login`, { 
                method: 'POST',
                headers: {
    ...
    return(
        <div className="min-h-screen flex flex-col justify-center py-36 px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <Link to="/sign-up" className="font-medium text-secondary hover:text-primary">SignUp</Link>
                </p>
            </div>
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-white py-8 px-6 shadow-lg rounded-lg sm:px-10">
                    <form id="loginForm" className="mb-0 space-y-6" method="POST" onSubmit={HandleSubmit}>
                        ...
                        <div>
                            <button type="submit" className="w-full flex justify-center py-4 px-4 border border-transparent rounded shadow-sm text-sm font-medium text-white bg-secondary hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">Login</button>
                        </div>
                        ...
                        { data &&
                            <div className="text-white px-8 py-4 border-0 rounded relative mb-4 bg-green-500">Success. Redirecting now...</div>
                        }
